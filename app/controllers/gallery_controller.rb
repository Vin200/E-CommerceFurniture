class GalleryController < ApplicationController
  ...
  def checkout
    ...
    def search
      ...
      @furnitures_gallery = Store.find_by_sql ["Select * from stores WHERE name like ? or category like ? or description like ? ",keyword,keyword,keyword]
    end
end